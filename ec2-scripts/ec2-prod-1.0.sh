...
cd /home/ec2-user
git clone https://github.com/arg00/ig.git
chown -R ec2-user:ec2-user ig

CONFIG_BUCKET="s3://edu.au.cc.arg0055.image-gallery-config"
...
su ec2-user -l -c 'cd ~/ig && ./start' >/var/log/image_gallery.log 2>&1 &
